...
from scripts.merger.bw_merger import TYPES,umerge,filenamecutter,wpreseter
from scripts.merge_utils.utils import usemodelgen
    ...
    for y in ys:
        ...
        for x in xs:
            ...
            if not (xtype=="seed" and xcount > 0):
               _ , currentmodel,modelid,theta_0,_=umerge(weights_a_in,weights_b_in, model_a,model_b,model_c, float(alpha),float(beta),mode,calcmode,
            ...
            image_temp=uimggen(prompt, nprompt, steps, sampler, cfg, seed, w, h,hireson,hrupscaler,hr2ndsteps,denoise_str,hr_scale,1,currentmodel,id_sets,modelid)
