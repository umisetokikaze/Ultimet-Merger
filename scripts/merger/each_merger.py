...
def eachmergegen(weights_a,weights_b,model_a,model_b,model_c,base_alpha,base_beta,mode,
                    ...
                    currentmodel,skip_position_ids,imggen):
    deepprint  = True if "print change" in esettings else False

    result,currentmodel,modelid,theta_0,metadata = eachmerge(
                        weights_a,weights_b,model_a,model_b,model_c,base_alpha,base_beta,mode,calcmode,
                useblocks,custom_name,save_sets,id_sets,wpresets,deep,tensor,deepprint,skip_position_ids)
...
def eachmerge(weights_a,weights_b,model_a,model_b,model_c,base_alpha,base_beta,mode,calcmode,
                useblocks,custom_name,save_sets,id_sets,wpresets,deep,tensor,deepprint,skip_position_ids):
    ...
    mergedmodel =["None",base_alpha,base_beta,
                            model_a,model_b,model_c,
                            "None", base_alpha, base_beta, mode,useblocks, "True", custom_name,save_sets,id_sets,deep,calcmode,tensor].copy()
